...
# """
from Solar import Star, Satellite, RevolvingSystem
...
def run(run_all=False, run_earth=False, run_jupiter=False):
...
if __name__ == "__main__":
    run(run_jupiter=False, run_earth=False, run_all=True)